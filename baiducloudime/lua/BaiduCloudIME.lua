...
CloneClass(ChatGui)
Hooks:RegisterHook( "IMEChatGuiEnterText" )
function ChatGui.enter_text(this, o, s)
   log("Enter text.. " .. s)
   result = this.orig.enter_text(this, o, s)
   Hooks:Call("IMEChatGuiEnterText", this, o, s)
   return result
end

Hooks:RegisterHook( "IMEChatGuiEnterKeyCallBack" )
function ChatGui.enter_key_callback(this)
   Hooks:Call("IMEChatGuiEnterKeyCallBack", this)
...
Hooks:Add("IMEChatGuiEnterText", "ChatGuiEnterTextIME",
          function(gui, o, s)
...
Hooks:Add("IMEChatGuiEnterKeyCallBack", "ChatGuiEnterKeyCallBackIME",
          function(gui)
             if not IMEEnable then
                return
             end
...
Hooks:RegisterHook("IMEChatGuiKeyPressed")
function ChatGui.update_key_down(this, o, k)
   log("Update key down hook")
   Hooks:Call("IMEChatGuiKeyPressed", this, o, k)
   return this.orig.update_key_down(this, o, k)
end

Hooks:Add("IMEChatGuiKeyPressed", "ChatGuiKeyPressedIME",
          function (gui, o, k)
             if not IMEEnable then
                return
             end
